$(function () {
    ...
    $('.subscribe-form').on("submit", function (event) {
        ...
        posting.done(function () {
            $form.html('<h4 class="subscribe-title" style="margin-bottom: 25px; line-height: 56px;">Thank you!</h4>').fadeTo(300, 1);
        });
    ...
    $('.contact-form').on("submit", function (event) {
        ...
        // Put the results in a div
        posting.done(function () {
            $form.html('<h4>Thank you for contacting us! We will get back to you soon</h4>').fadeTo(300, 1);
        });
